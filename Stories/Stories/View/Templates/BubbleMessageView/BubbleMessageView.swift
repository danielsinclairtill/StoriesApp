...
class BubbleMessageView: UIView {
    ...
    static func instertInto(containerView: UIView, message: String) -> BubbleMessageView {
        ...
        bubbleMessageView.layer.shadowColor = StoriesDesign.shared.theme.attributes.colors.primaryFill().cgColor
        bubbleMessageView.layer.shadowOpacity = 0.2
        bubbleMessageView.layer.shadowOffset = .zero
        bubbleMessageView.layer.shadowRadius = 5
        
        bubbleMessageView.backgroundColor = StoriesDesign.shared.theme.attributes.colors.primary()
        ...
        bubbleMessageView.messageLabel.font = StoriesDesign.shared.theme.attributes.fonts.primaryTitle()
        bubbleMessageView.messageLabel.textColor = StoriesDesign.shared.theme.attributes.colors.primaryFill()
